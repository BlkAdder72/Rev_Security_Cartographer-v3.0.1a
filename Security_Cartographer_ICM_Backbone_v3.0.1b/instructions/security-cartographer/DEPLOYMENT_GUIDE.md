...
```powershell
$Package = "C:\path\to\Security_Cartographer_ICM_Backbone_v3.0.1b"
...
```sh
PACKAGE="/path/to/Security_Cartographer_ICM_Backbone_v3.0.1b"
...
- [ ] The callable runtime installs and reports version 3.0.1b.
